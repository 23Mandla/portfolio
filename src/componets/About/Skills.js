...
export default function Skills() {
  ...
  return (
    <div className="relative  h-screen p-16">
      <h1 className="relative text-4xl pl-5 top-12 float-left left-10 after:content-[''] after:absolute after:bg-gray-600 after:h-[1px] after:w-[50%] after:top-14 after:left-[30%]">My skills</h1>
