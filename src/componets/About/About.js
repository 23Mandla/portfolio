...
export default function About() {
  return (
    <div className="bg-[#858585] ] h-full w-[90%] m-auto grid grid-cols-3 text-[#313030]">
      <div className="relative">
        <div className="absolute top-[15%] left-[39%] w-full h-1/2 bg-pink-400">
          <div className="absolute top-0 left-0 w-full h-full holder"></div>
          <img src={me} alt="" className="w-full h-full object-cover" />
        </div>
        <h1 className="absolute bottom-20 font-bold w-full text-center text-4xl">
          ABOUT ME
        </h1>
      </div>
      <div className="bg-[#dfdfdf] col-span-2 pr-4 py-5">
        <div className="w-[80%] h-full float-right p-8 space-y-8 bg-[#c7c3c0] text-[#4A4A4A]">
          <p>
          ...
          <div className="flex gap-10">
            <div className="bg-[#ADBAC7] p-2 flex items-center justify-center rounded-full hover:scale-110 transition-all">
              <FaGithub className="text-xl text-[#1C2128] cursor-pointer"/>
            </div>
            <div className="bg-[#ADBAC7] p-2 flex items-center justify-center rounded-full cursor-pointer  hover:scale-110 transition-all">
